...
purpose: "Wrapper templates for `memory_bank/epics/EP-XXX/` packages: charter, roadmap, decision log, subissues, and risks."
derived_from:
  - ../../epic-flow.md
status: active
...
Use these templates when creating a new `memory_bank/epics/EP-XXX/`.
